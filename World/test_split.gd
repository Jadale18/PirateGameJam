...
@onready var characters := {
	"character": {
		...
		camera = $"VBoxContainer/TopViewportContainer/TopViewport/Level1/Camera2D",
	...
	"shadow": {
		...
		camera = $"VBoxContainer/BottomViewportContainer/BottomViewport/ShadowLevel1/Camera2D",
